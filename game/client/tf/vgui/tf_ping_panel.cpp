...
void CTFPingPanel::ApplySchemeSettings( IScheme *pScheme )
{
	...
	m_pCustomPingCheckBox = FindControl< CvarToggleCheckButton<ConVarRef> >( "CustomPingCheckButton", true );
	m_pIgnoreInvitesCheckBox = FindControl< CvarToggleCheckButton<ConVarRef> >( "IgnorePartyInvites", true );
	m_pKeepTeamTogetherCheckBox = FindControl< CvarToggleCheckButton<ConVarRef> >( "KeepPartyOnSameTeam", true );

...
private:
	...
	CvarToggleCheckButton<ConVarRef> *m_pCustomPingCheckBox = NULL;
	CvarToggleCheckButton<ConVarRef> *m_pIgnoreInvitesCheckBox = NULL;
	CvarToggleCheckButton<ConVarRef> *m_pKeepTeamTogetherCheckBox = NULL;

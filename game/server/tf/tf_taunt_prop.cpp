...
bool CTFTauntProp::StartSceneEvent( CSceneEventInfo *info, CChoreoScene *scene, CChoreoEvent *event, CChoreoActor *actor, CBaseEntity *pTarget, CSceneEntity *pSceneEnt )
#else
...
#endif
{
	...
	default:
#ifdef MAPBASE_VSCRIPT
		return BaseClass::StartSceneEvent( info, scene, event, actor, pTarget, pSceneEnt );
#else

...
public: // IGameEventListener Interface
	...
	virtual bool IsOfficialMap( void ) { return false; }
...
protected:
	...
	bool						m_bPlayerReadyBefore[MAX_PLAYERS + 1];
...
protected:
	...
	CNetworkVar( float,			m_flCountdownTime );					// Optional pre-round countdown end time

...
#endif
{
	...
	m_pSavedMaterialOverride = NULL;
	m_nSavedMaterialOverrideType = OVERRIDE_NORMAL;
	m_bUsingDroppedWeaponMaterialOverride = false;
#endif // CLIENT_DLL
...
bool CTFDroppedWeapon::OnInternalDrawModel( ClientModelRenderInfo_t *pInfo )
{
	...
	{
		modelrender->GetMaterialOverride( &m_pSavedMaterialOverride, &m_nSavedMaterialOverrideType );
	}
	...
	if ( pInfo->flags & STUDIO_RENDER )
	{
		IMaterial *pMaterialOverride = GetEconWeaponMaterialOverride( GetTeamNumber() );
		if ( pMaterialOverride && !m_pSavedMaterialOverride && m_nSavedMaterialOverrideType == OVERRIDE_NORMAL )
		{
			modelrender->ForcedMaterialOverride( pMaterialOverride );
			m_bUsingDroppedWeaponMaterialOverride = true;
		}
	}
...
//-----------------------------------------------------------------------------
bool CTFDroppedWeapon::OnPostInternalDrawModel( ClientModelRenderInfo_t *pInfo )
{
	if ( m_bUsingDroppedWeaponMaterialOverride )
	{
		modelrender->ForcedMaterialOverride( m_pSavedMaterialOverride, m_nSavedMaterialOverrideType );
		m_bUsingDroppedWeaponMaterialOverride = false;
	}
